...
class KeypointAlignmentDataset(BothMidCoronalDataset):
    def __init__(self,
                 ...
                 annotations_path='/scratch/shared/beegfs/rhydian/UKBiobank/files-for-annotation/', reload_if_fail=False):
        super().__init__(set_type='test',all_root=all_root,crop_scans=True,augment=False,reload_if_fail=reload_if_fail, equal_res=True)
