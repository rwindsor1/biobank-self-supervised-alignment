...
echo $start_frac
echo $end_frac
python make_registration_refinement_dataset.py --start_frac=$start_frac --end_frac=$end_frac --set_type=train
python make_registration_refinement_dataset.py --start_frac=$start_frac --end_frac=$end_frac --set_type=val
python make_registration_refinement_dataset.py --start_frac=$start_frac --end_frac=$end_frac --set_type=test
